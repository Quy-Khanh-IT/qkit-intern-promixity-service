        ...
        <div className="content-wrapper">
          ...
          <div className="content-right d-none d-xl-block">
            ...
            <div className="content">
              ...
              <div className="quote">
                "Amidst this vast world, map-search applications serve as
                gateways to explore the wonders of our planet, guiding us from
                narrow streets to towering mountains. They not only lead us to
                places but also instill a sense of wonder in the art of
                discovery."
              </div>
              <div className="quote-owner">Trương Nguyễn Công Chính</div>
              <div style={{ marginTop: "8px" }}>
                Full-stack Intern at QKIT Software
              </div>
