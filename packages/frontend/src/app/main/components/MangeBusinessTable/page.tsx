...
import { MANAGE_BUSINESS_FIELDS, MANAGE_BUSINESS_SORT_FIELDS } from './manage-business-table.const'
import './manage-business-table.scss'
...
const ManageBusinessTable = (): React.ReactNode => {
  // Pagination
...
export default ManageBusinessTable
